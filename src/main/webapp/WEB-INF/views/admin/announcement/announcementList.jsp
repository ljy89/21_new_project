...
<table>
  ...
  <td width="642">
     ...
     <input class="btn" type="button" name="btn_search" value="검색" onClick="go_ann_search()">
     <input class="btn" type="button" name="btn_total" value="전체보기 " onClick="go_ann_total()">
...
<table id="productList">
    ...
    <tr>
     ...
     <%--  <a href="admin_product_detail${pageMaker.makeQuery(pageMaker.cri.pageNum)}&sseq=${noticeVO.sseq}"> --%>
		  <a href="#" onclick="ann_detail('${announcementVO.aseq}')">
