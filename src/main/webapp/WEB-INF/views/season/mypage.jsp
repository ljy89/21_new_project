...
<script type="text/javascript" src="https://cdn.iamport.kr/js/iamport.payment-1.1.5.js"></script>
 ...
 <script type="text/javascript">
 	...
 	$(document).ready(function(){
 		var subTotalPrice =  document.getElementById("subTotalPrice").value;
 		
 		var IMP = window.IMP; // 생략가능
        IMP.init('imp35022456'); // 'iamport' 대신 부여받은 "가맹점 식별코드"를 사용
        var msg;
  ...
  <article>
    <h2>결제 내역(${title}) </h2>
    <input type="hidden" id="subTotalPrice" name="subTotalPrice"  value="${subTotalPrice}">
