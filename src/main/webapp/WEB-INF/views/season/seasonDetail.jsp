...
<form name="frm" id="detail_form" method="post">
	<div>
		<input type="hidden" id="sseq" name="sseq" value="${seasonVO.seseq}"> <br>
		<table id="list">
			<tr>
				<th>학과명</th>
				<td>${seasonVO.dname}</td>
			</tr>
			...
			<tr>
				...
				<td><fmt:formatNumber type="currency" value="${seasonVO.price}" /></td>
			</tr>
			
			<tr>
				<th>수업 소개</th>
				<td>${seasonVO.content}</td>
			</tr>
...
<input type="button" value="장바구니에 담기"   class="submit"    onclick="go_season_cart(${seasonVO.seseq})"> 
<input type="button" value="결제"       class="submit"    onclick="go_season_order(${seasonVO.seseq})">
<input type="button" value="목록"       class="submit"    onclick="go_season_list()"> 
<!-- 
